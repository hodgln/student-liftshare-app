...
const ConfirmationScreen = ({ route }) => {
    ...
    const onGoPress = async () => {
        try {
            ...
            const response = await fetch(`http://192.168.86.99:8081/confirmation/${value}`, {
                method: 'GET',
                headers: { token: token }
            });
    ...
    const saveToken = async(pushToken, existingStatus) => {
        ...
        try {
            ...
            await fetch("http://192.168.86.99:8081/auth/pushToken", {
                method: 'PUT',
                headers: myHeaders,
    ...
    const confirmationHandler = async (email, token) => {
        try {
            ...
            const response = await fetch(`http://192.168.86.99:8081/confirmation/email/${email}`, {
                method: 'POST',
                headers: myHeaders,
            });
